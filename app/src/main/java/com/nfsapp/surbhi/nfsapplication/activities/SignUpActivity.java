...
public class SignUpActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        final EditText middleNameEt = findViewById(R.id.middlenameEt);
        final EditText lastNameEt = findViewById(R.id.lastNameEt);
        ...
        next_signup.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if (!isValidPassword(password)) {
                    makeToast(SignUpActivity.this, "Enter a combination of atleast 6 characters ,includes atleast 1 uppercase character , 1 symbol and 1 number. ");
                    return;
                }

                signup(code, phone, name, middleName, lastName, email, password);
            }
        });
    ...
    private void signup(final String code, final String phone, String name, String middle_name, String last_name, String email, final String password) {
