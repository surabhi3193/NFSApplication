...
public class ItemForSentDetailsFrag extends Fragment {
    ...
    private void prepareTravellerData() {
        Traveller movie = new Traveller("Laptop HP", "Pickup : Chicago", "Destination : Naperville", "04/03/2018", "50 KM");
        travellerList.add(movie);


        movie = new Traveller("Laptop HP", "Pickup : Chicago", "Destination : Naperville", "04/03/2018", "50 KM");
        travellerList.add(movie);
